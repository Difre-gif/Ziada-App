...
st.set_page_config(page_title="Ziada App Kenya", layout="wide")
st.header("Ziada App")
...
# Footer
st.sidebar.write("# Ziada App: AI-Powered Homework Feedback & Marking Assistant")
st.sidebar.write("Imagine an AI-powered tool designed to help you seek feedback and access a mark scheme for your homework, empowering you to be your own teacher. With this tool, you can easily check your work, analyze your answers, and understand how to improve based on feedback generated by the AI. It breaks down complex concepts into understandable explanations, making it easier for you to learn and refine your skills, whether you’re tackling mathematics, science, or any other subject. Once you’ve used this tool, you’ll realize just how much it enhances your learning experience. Not only does it provide valuable insights into where you might have gone wrong, but it also guides you in aligning your work with the appropriate grading criteria. With this AI assistant by your side, learning becomes a continuous cycle of improvement, and soon, you’ll never want to go back to traditional methods of self-assessment.")
